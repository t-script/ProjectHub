    ...
    KanbanColumns.create([
      ...
      /* // INSERT TEST DATA
       Tickets.create([
         ...
         {ticketid: 3, title: 'Ticket3', description: 'Test Ticket', position: 3, columns: columns[1].id, user: 15, project: obj.id},
         {ticketid: 4, title: 'Ticket4', description: 'Test Ticket', position: 4, columns: columns[1].id, user: 15, project: obj.id},
         ...
         {ticketid: 10, title: 'Ticket10', description: 'Test Ticket', position: 3, columns: columns[3].id, user: 15, project: obj.id},
       ]).exec(function(err, columns) {
       if (err) return cb(err);
       cb();
      });*/
